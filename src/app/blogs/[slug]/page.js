...
export default function BlogDetailPage() {
  ...
  const content = {
    ...
    np: {
      ...
      eyebrow: "ब्लग",
      backToBlogs: "← ब्लगहरूमा फर्कनुहोस्",
      notFound: "ब्लग पोस्ट फेला परेन।",
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const found = blogs.find(item => item.slug === params.slug);
      setBlog(found || null);
    }
    setLoading(false);
  }, [params.slug]);
      ...
      <div className="page-wrapper">
        ...
        <main className="content-detail">
          <div className="container">
            <p>{t.notFound}</p>
            <Link href="/blogs" className="btn btn-primary">{t.backToBlogs}</Link>
          </div>
        </main>
      </div>
    );
  ...
  return (
    <div className="page-wrapper">
      ...
      <main className="content-detail">
        <div className="container">
          <Link href="/blogs" className="back-link">{t.backToBlogs}</Link>
          ...
          <article className="detail-article">
            ...
            <div className="body" dangerouslySetInnerHTML={{ __html: blog.body || blog.excerpt }} />
          </article>
        </div>
      </main>
