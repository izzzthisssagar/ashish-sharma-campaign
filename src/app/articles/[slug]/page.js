...
export default function ArticleDetailPage() {
  ...
  const content = {
    ...
    np: {
      ...
      eyebrow: "लेख",
      backToArticles: "← लेखहरूमा फर्कनुहोस्",
      ...
      <div className="page-wrapper">
        ...
        <main className="content-detail">
          <div className="container">
            <p>{t.notFound}</p>
            <Link href="/articles" className="btn btn-primary">{t.backToArticles}</Link>
          </div>
        </main>
      </div>
    );
  ...
  return (
    <div className="page-wrapper">
      ...
      <main className="content-detail">
        <div className="container">
          <Link href="/articles" className="back-link">{t.backToArticles}</Link>
          ...
          <article className="detail-article">
            ...
            <div className="body" dangerouslySetInnerHTML={{ __html: article.body || article.excerpt }} />
          </article>
        </div>
      </main>
