...
export default function ArticlesPage() {
  ...
  const t = {
    ...
    np: {
      ...
      pageTitle: "लेखहरू",
      noArticles: "अहिलेसम्म कुनै लेख छैन। चाँडै फर्केर हेर्नुहोस्!",
  ...
  const defaultArticles = [
    {
      ...
      excerpt: language === "np" ? "कपिलवस्तुलाई विकासको मुख्यधारमा ल्याउन आवश्यक कदमहरू र नयाँ रणनीतिहरू..." : "Steps and new strategies needed to bring Kapilvastu into the mainstream of development...",
      date: "2082-01-10",
      source: "Kantipur",
      image: "/portrait.jpg",
    },
    {
      ...
      excerpt: language === "np" ? "स्थानीय स्तरमा रोजगारी सिर्जनाका उपायहरू र युवाहरूका लागि अवसरहरू..." : "Measures for employment creation at the local level and opportunities for youth...",
      date: "2082-01-15",
    ...
    },
    {
      ...
      excerpt: language === "np" ? "गुणस्तरीय शिक्षाले समाजको रूपान्तरण गर्छ र राष्ट्रको विकासमा महत्वपूर्ण भूमिका खेल्छ..." : "Quality education transforms society and plays a vital role in national development...",
      date: "2082-01-20",
      source: "Nagarik",
      image: "/portrait.jpg",
    },
        ...
        <div className="container">
          <div className="header-inner">
            ...
            <nav className={`nav ${menuOpen ? "open" : ""}`}>
              ...
              <Link href="/articles" className="nav-link active">{text.articles}</Link>
        ...
        <div className="container">
          <div className="articles-list">
            {displayArticles.map((article) => (
              <Link href={`/articles/${article.id}`} key={article.id} className="article-list-item">
                <div className="article-list-img">
                  <img src={article.image || "/portrait.jpg"} alt={article.title} />
                </div>
                <div className="article-list-content">
                  <div className="article-list-meta">{article.source || "Article"}, {article.date}</div>
